...
class KhoaAdmin(admin.ModelAdmin):
	list_display = ['ma_khoa', 'ten_khoa', 'updated_by']

class KhoaHocAdmin(admin.ModelAdmin):
	list_display = ['ma_khoa_hoc', 'ten_khoa_hoc', 'updated_by']

class Khoa_KhoaHocAdmin(admin.ModelAdmin):
	list_display = ['ma_khoa', 'ma_khoa_hoc']

class GiangVienAdmin(admin.ModelAdmin):
	list_display = ['ma_giang_vien', 'ten_giang_vien', 'gioi_tinh', 'so_dien_thoai', 'email', 'ngay_sinh', 'updated_by']

class LopAdmin(admin.ModelAdmin):
	list_display = ['ma_lop', 'ten_lop', 'ma_khoa_hoc', 'updated_by']

class SinhVienAdmin(admin.ModelAdmin):
	list_display = ['ma_sinh_vien', 'ten_sinh_vien', 'gioi_tinh', 'so_dien_thoai', 'email', 'ngay_sinh', 'ma_lop', 'updated_by']

class MonHocAdmin(admin.ModelAdmin):
	list_display = ['ma_hoc_phan', 'ten_hoc_phan', 'gioi_han', 'da_dang_ky', 'so_tin_chi', 'ma_giang_vien', 'ma_khoa_hoc', 'ma_khoa', 'updated_by']
